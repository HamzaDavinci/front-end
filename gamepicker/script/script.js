...
games.forEach(game => {
    // de main wrapping van de game content
    let group = document.createElement("section");

    // div voor title en price met flex
    ...
    // cart_button.innerText = "Toevoegen aan winkelwagen";
    // cart_button.addEventListener("click", function(){
    //     alert("je hebt op de knop geklikt voor het spel: " + game.title);
    // });
    // group.appendChild(cart_button);

    // zorgt ervoor dat het in de main body komt
